...
let EmailService = EmailService_1 = class EmailService {
    constructor(configHelper) {
        ...
        this.CALENDLY_LINK = 'https://calendly.com/contact-girlsincryptohub';
    ...
    async sendEbookDelivery(email, customerName, productName, fileUrl) {
        try {
    ...
    async sendMentorshipBooking(email, customerName, productName) {
        try {
            await this.transporter.sendMail({
                from: this.fromEmail,
                to: email,
    ...
    async sendProductDelivery(email, productName, fileUrl, productType, customerName) {
